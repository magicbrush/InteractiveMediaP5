...
// 移动贴图
// ---------------- 轨迹变化 ----------------//
function line_randMoveSprite_0011(
	x0,y0,x1,y1,
	randness,res,
	SpriteFcn,Scale,Spd,T0)
{
	// 画出贴图
	var TNow = Spd * millis()/1000 + T0; // 时间
...
function line_rollMoveSprite_0011(
	x0,y0,x1,y1,
	radius,Freq,res,
	SpriteFcn,Scale,Spd,T0)
{
...
function line_noiseMoveSprite_0011(
	x0,y0,x1,y1,
	Amp,Freq,res,
	SpriteFcn,Scale,Spd,T0)
{
